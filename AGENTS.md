...
This is a collection of Codex AI skill definitions. Each skill is a standalone folder with a consistent structure.

## Skill Structure

Every skill folder contains:

- `skill.md` — the skill definition loaded into the Codex platform. Has a YAML frontmatter block with `name` and `description`, followed by Markdown instructions.
...
---
name: skill-name
description: Trigger conditions and what the skill does. This is what the Codex platform uses to decide when to activate the skill.
---
```
